...
#
# Script generated by Vivado on Wed Jul 01 01:10:13 +0200 2026
...
export RDI_DATADIR="D:/Universidad_programas/AMD/2025.1/Vivado/data"
...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Universidad_programas/AMD/2025.1/Vivado/data/xsim"
  fi
