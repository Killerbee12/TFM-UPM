...
#
# Script generated by Vivado on Wed Aug 05 19:03:07 +0200 2026
...
export RDI_DATADIR="C:/AMD/2025.1/Vivado/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_13 -L util_vector_logic_v2_0_5 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_f60c.protoinst" -protoinst "protoinst_files/bd_f69c.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/AMD/2025.1/Vivado/data/xsim"
  fi
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib util_vector_logic_v2_0_5)
